...
<td><input type="text" class="demoInputBox" name="university_name" minlength="3" maxlength="16" value=" <?php if(isset($_POST['university_name'])) echo $_POST['university_name']; ?>" required ></td>
</tr>
<tr>
<td>first_name</td>
