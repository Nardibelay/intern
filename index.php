...
<html lang = "en">
	<head>
		<title>Camara-Internship portal</title>
		<meta charset = "UTF-8" />
...
?>
	...
	<div class = "container-fluid" id = "content">	
		<div class = "row" style = "margin-top:-120px;">	
				...
				<ul class="nav nav-tabs">
					...
					<li><a href="#activities" data-toggle = "tab"><b>Internship Vacancy</b></a></li>
				</ul>
				<br />
	...
	<nav class = "navbar-default" id = "footer">
		<label class = "navbar-brand pull-right">&copy;Camara internship management system<?php echo date('Y', strtotime('+8 HOURS'))?></label>
		<label class = "navbar-brand ">ethiopia@camara.org</label>
	</nav>
</body>	
