...
$sql="INSERT INTO fill_details (university_name, first_name, last_name,email,gender,file)
VALUES
( '$_POST[university_name]','$_POST[first_name]','$_POST[last_name]','$_POST[email]','$_POST[gender]','$fname')";
